...
urlpatterns = [
    ...
    path('<int:pk>/update/', views.TaskUpdateView.as_view(), name='tasks_update'),  # noqa: E501
    path('<int:pk>/delete/', views.TaskDeleteView.as_view(), name='tasks_delete'),  # noqa: E501
]
